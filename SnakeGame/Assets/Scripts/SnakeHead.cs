...
public class SnakeHead : BodyPart
{
    ...
    void Start()
    {
        SwipeControllers.OnSwipe += SwipeDetection;
    }
    ...
    public void ResetSnake()
    {
        ...
        gameObject.transform.localEulerAngles = new Vector3(0, 0, 0);//points up
    ...
    void SwipeDetection(SwipeControllers.SwipeDirection direction)
    {
        switch (direction)
        {
            case SwipeControllers.SwipeDirection.Up:
                MoveUp();
                break;
            case SwipeControllers.SwipeDirection.Down:
                MoveDown();
                break;
            case SwipeControllers.SwipeDirection.Left:
                MoveLeft();
                break;
            case SwipeControllers.SwipeDirection.Right:
                MoveRight();
                break;
        }
    }
